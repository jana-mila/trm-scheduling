...
from src.regression.datamodule import JobShopDataModule
from src.regression.model import TinyRecursiveModelJobShop

@hydra.main(version_base=None, config_path="../../configs/regression", config_name="default_1k_2dim")
